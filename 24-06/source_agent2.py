"""
source_agent2.py
Local compatibility wrapper for the source-of-truth Agent2 implementation.
This file preserves the duplicate implementation without merging it into
24-06/agent2.py.
"""
...
_rule_matches_frameworks = _rule_matches_frameworks
